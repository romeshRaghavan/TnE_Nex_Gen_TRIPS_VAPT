...
var WebServicePath = 'https://appservicesnew.expenzing.com/nexstepwebservice/mobileLinkResolver.service';
...
//----------------------------------****************----------------------------------//							  	 
							  	 /*alert("amount from table:"+j(this).find('td.expAmt1').text());
							  	 var encAmt = j(this).find('td.expAmt1').text();
							  	 var str1 = "expenzing"
							  	 encryptData(str1)
							  	 alert("!!!!!!!!!:"+)
							  	 alert(decryptData(encAmt));
...
function viewMessages(){
	...
	function saveIncomingSMSOnLocal(e){
		alert("in saveIncomingSMSOnLocal");
		var sms =e.data;
		smsList.push(sms);
	// console.log(sms);
